...
import (
	...
	"bitbucket.org/zombiezen/goray/std/textures/image"
)

func openImage(fspath string) (img *goray.Image, err error) {
...
func New(base string) image.Loader {
	return image.LoaderFunc(func(name string) (img *goray.Image, err error) {
		if name == "" {
